...
Current package: **1.9.1**. The 2026-07-24 security/correctness review is **closed** on **1.8.7–1.8.11**. **1.9.0** opened the prep minor; **1.9.1** hardens IAP cancel/single-flight. **Server / Cloud Code** work starts at **1.10.0**.
