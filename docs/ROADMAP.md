...
Current package: **1.9.0**. The 2026-07-24 security/correctness review is **closed** on **1.8.7–1.8.11**. **1.9.0** is the prep minor after that hotfix stream; **server / Cloud Code** work starts at **1.10.0**.
