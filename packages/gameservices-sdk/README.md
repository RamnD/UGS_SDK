...
{
  "dependencies": {
    "com.ramnd.gameservices-sdk": "https://github.com/RamnD/UGS_SDK.git?path=packages/gameservices-sdk#v2.1.16"
  }
}
```
...
| App update (Play Immediate) | [docs/app-update.md](docs/app-update.md) |
